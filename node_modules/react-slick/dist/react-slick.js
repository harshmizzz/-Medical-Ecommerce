  ...
  _createClass(Dots, [{
    ...
    value: function render() {
      ...
      for (var i = 0; i < dotCount; i++) {
        ...
        dots = dots.concat(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          key: i,
          className: className
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(this.props.customPaging(i), {
          onClick: onClick
        })));
      }
