    ...
    <>
      <div className="header">
        ...
        <Link style={{ textDecoration: "none" }} to="/">
          ...
          <img className="header__logo" src={logo} alt="Nike logo" />
        </Link>
        <div className="header__nav">
          ...
          <Link style={{ textDecoration: "none" }} to="/men">
            <span className="header__navItems">Medicines</span>
          </Link>
          ...
          <Link style={{ textDecoration: "none" }} to={!user && "/login"}>
            <div className="header__user" onClick={onLogin}>
              <span className="header__hello">
                Hello, <span className="header__mail">{user?.email}</span>
              </span>
              <span className="header__navRightItems">
        ...
        <div className="header2__nav">
          <Link style={{ textDecoration: "none" }} to={!user && "/login"}>
            <div className="header2__user" onClick={onLogin}>
              <span className="header2__hello">
                Hello, <span className="header2__mail">{user?.email}</span>
              </span>
              <span className="header2__navSign">
                {user ? "Sign Out" : "Log In/Sign Up"}
              </span>
            </div>
          </Link>
